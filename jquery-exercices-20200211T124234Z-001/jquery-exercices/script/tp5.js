...
(function ($) {
	...
	$(document).ready(function(){
		...
		*/
		...
		var $tables = $('table').hide(); // cache les tableaux
		...
		*/
		...
		var cssDefault = {
			paddingLeft : $items.eq(0).css("paddingleft")
		};
		$items.hover(
			function(){
				$(this).animate({paddingLeft:"40px"},1000);
			},
			function(){
		...
		*/
		$.fx.off = true;
		$items.eq(0).click();     //eq(0) = faire apparaitre le premier 
		$.fx.off = false;
